...
<div class="content container">
    ...
    <div class="sixteen columns">
        <h1 class="title">赛事章程</h1>
    </div>

    <div class="cblock padding">
        <div class="one-third column">
            <h2>章程列表</h2>
            <ul class="bullet" style="width: 900px;">
                <li style="width: 900px;"><a href="law_detail.jsp">
                    <div style="display: inline-block">zhanasdasdasdas1asdasd</div>
                </a>
                    <div style="display: inline-block;float: right;margin-right: 20px;">2017-09-15</div>
                </li>
                <li style="width: 900px;"><a href="law_detail.jsp">
                    <div style="display: inline-block">zhanasdasdasdas1asdasd</div>
                </a>
