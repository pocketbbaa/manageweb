    ...
    <div class="twelve columns">
        ...
        <div class="cblock empty blog_post">
            ...
            <div class="post_content">
                ...
                <p>（1）参赛选手在规定的时间内使用提供的2张A4大小纸张现场制作一至两架纸飞机，每队可报3人组成团体赛。
                </p>
                <p>（2）在规定的场地中，选手将飞机掷出，以距离判定成绩，远者名次列前。
                </p>
                <p>（3）在比赛中飞机飞出边线成绩为0分。
                </p>
                <p>（4）比赛进行两轮，以最好一轮成绩作为运动员最终成绩。
                </p>
                ...
                <p>（2）运动员用气流生成板（40*30）操纵纸飞机，在规定区域内进行飞行，纸飞机触及任何物品该轮比赛终止记时。取最好一次成绩。
                </p>
                <p>（3）比赛进行两轮，以最好一轮成绩作为运动员最终成绩。
                </p>
        ...
        <div class="blog_post_comments">
            ...
            <ul>
                ...
                <li class="comment odd alt thread-odd thread-alt depth-1" id="li-comment-7">
                    <div class="parent" id="comment-7">
                        <div class="clearfix">
                            <div class="comment-details">
                                <p>二、中学、小学组、亲子组前3名为一等奖、4-8为二等奖、9-12为三等奖、团体总分奖颁发奖杯。</p>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="comment even thread-even depth-1" id="li-comment-10">
                    <div class="parent" id="comment-10">
                        <div class="clearfix">
                            <div class="comment-details">
                                <p>三、颁发优秀组织奖、优秀教练员奖。</p>
                            </div>
                        </div>
                    </div>
                </li>
